...
LABEL description="Charm Django-Wagtail backend"

MAINTAINER Simon Prast <simon.prast.sp@gmail.com>
# Base by Florian Kleber <kleberbaum@erebos.xyz>

# Add custom environment variables needed by Django or your settings file here:
ENV DJANGO_DEBUG=on \
	DJANGO_SETTINGS_MODULE=charm.settings.production

# uWSGI configuration (customize as needed):
ENV UWSGI_VIRTUALENV=/venv \
	UWSGI_UID=1000 \
	UWSGI_GID=2000 \
	UWSGI_WSGI_FILE=charm/wsgi_production.py \
	UWSGI_HTTP=:8000 \
	UWSGI_MASTER=1 \
	UWSGI_WORKERS=2 \
	UWSGI_THREADS=1
